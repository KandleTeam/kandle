...
public class MockAuthentication implements Authentication {
    ...
    @Override
    public Task<User> createUserWithEmailAndPassword(String username, String email, String password, Map<String, Object> usernameMap) {
        ...
        if (accounts.containsKey(email)) {
            ...
            DependencyManager.getDatabaseSystem().createUser(userToRegister, usernameMap);
            isConnected = true;
